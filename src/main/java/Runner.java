...
public class Runner {
    ...
    private static ApigeeAPIConfig loadApigeeAPIConfig() {
        ...
        try {
            ...
            Boolean proxy_pathsuffix_dimension = Boolean.parseBoolean(props.getProperty("proxy_pathsuffix_dimension"));
            ...
            ApigeeAPIConfig apigeeAPIConfig = new ApigeeAPIConfig(api_host, organization, environment, api_proxies, api_proxies_inverse, api_product_dimension, client_id_dimension, developer_app_dimension, proxy_basepath_dimension, proxy_pathsuffix_dimension, enable_4xx_errors_request, enable_5xx_errors_request, username, password);
