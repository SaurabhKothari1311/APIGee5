...
public class ApigeeAPIConfig {
    ...
    public ApigeeAPIConfig(String api_host, String organization, String environment, String api_proxies, String api_proxies_inverse, Boolean api_product_dimension, Boolean client_id_dimension, Boolean developer_app_dimension, Boolean proxy_basepath_dimension, Boolean proxy_pathsuffix_dimension, Boolean enable_4xx_errors_request, Boolean enable_5xx_errors_request, String username, String password) {
        ...
        this.proxy_pathsuffix_dimension = proxy_pathsuffix_dimension;
