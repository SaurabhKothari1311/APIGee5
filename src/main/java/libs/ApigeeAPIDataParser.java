    ...
    public List<EventServiceRecord> parse() {
        ...
        try {
            ...
            for (JsonNode json_metrics : json_dimensions) {
                ...
                String proxy_pathsuffix_dimension = "";
                ...
                if (apigeeAPIConfig.proxy_pathsuffix_dimension) {
                    //This value is not always set for a path, but doesn't get the usual "(not set)"
                    if (dimensions_string.endsWith(",")) {
                        proxy_pathsuffix_dimension = "(not set)";
                    } else {
                        proxy_pathsuffix_dimension = dimensions[dimensionIndex];
                    }
                }
